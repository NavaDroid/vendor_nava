...
custom_local_manifest = ".repo/local_manifests/pixelstar.xml"
custom_default_revision = "14"
custom_default_revision =  os.getenv('ROOMSERVICE_DEFAULT_BRANCH', '14')
custom_dependencies = "nava.dependencies"
org_manifest = "NavaDroid-Devices"  # leave empty if org is provided in manifest
org_display = "NavaDroid-Devices"  # needed for displaying
